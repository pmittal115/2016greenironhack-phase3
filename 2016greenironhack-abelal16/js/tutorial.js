function initMap() {
    ...
    google.maps.event.addListener(marker, 'click', function() {
        infowindow.setContent("Welcome to the city of West Lafayette");
                            infowindow.open(map, marker);

    marker2 = new google.maps.Marker({
        position: {lat: 40.4250, lng: -86.9170},
        map: map,
    ...
    google.maps.event.addListener(marker2, 'click', function() {
        ...
        position: {lat: 40.4300, lng: -86.9070},
        map: map,
...
//location.reload();
        ...
        position: {lat: 40.4450, lng: -86.9350},
        map: map,
